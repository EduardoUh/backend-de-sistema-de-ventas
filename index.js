...
const { authRouter, sucursalesRouter, usuariosRouter, rolesRouter, proveedoresRouter, tiposProductosRouter, productosRouter, stockProductoRouter, clientesRouter } = require('./routes/index.js');
